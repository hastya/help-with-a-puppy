// Seed database of dog breeds with weight norms, common health issues and
// breed-specific notes. `adultWeightMin`/`adultWeightMax` are in kilograms.
// `activityFactor` is the default MER multiplier used by the calorie calculator.
// This is a curated demo set — in production this table is managed via the CMS.
